...
public class CCUMSocialController {
	...
	private static String umengAppKey = "5571001a67e58ee100009a81";
    /**
     * 友盟社会化组件控制器
     */
    ...
    {
    	System.out.println("java 友盟sdk init：");
        if (mController == null) {
    ...
    public static void setPlatformShareContent(int platformCode, String text, String imagePath,
        ...
        //
        Object shareObject = ReflectUtils.newHandlerInstance(mShareContentClzPathMap.get(platform), null, null);

        System.out.println("平台独立的分享内容 : " + shareObject);
        //
    ...
    static {
        // 设置渠道 (统计)
        String umengChannel = FeiyuSdk.getFYDataChannelName();
        System.out.println("java 设置umen渠道：" + umengChannel);
        AnalyticsConfig.setChannel(umengChannel);
        // 设置appkey (统计)
        AnalyticsConfig.setAppkey(mActivity, umengAppKey);
