...
- (void)viewDidLoad {
  ...
  if ( !items_ ) {
    items_ = [[NSArray alloc] initWithObjects:
                                @"UIKitPrjAlert",
                                @"UIKitPrjAlertWithLongMessage",
                                @"UIKitPrjAlertWithMultiButtons",
                                @"UIKitPrjAlertObserving",
                                @"UIKitPrjAlertDismiss",
                                @"UIKitPrjActionSheet",
                                @"UIKitPrjActionSheetWithToolbar",
                                @"UIKitPrjActionSheetWithTabBar",
                                @"UIKitPrjActionSheetStyle",
                                @"UIKitPrjActionSheetWithDestructiveButton",
                                @"UIKitPrjActionSheetObserving",
                                @"UIKitPrjStatusBarStyle",
                                @"UIKitPrjNetworkActivityIndicator",
                                nil ];
  } 
}
