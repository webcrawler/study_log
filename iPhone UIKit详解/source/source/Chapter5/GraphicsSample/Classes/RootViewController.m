...
- (void)viewDidLoad {
  ...
  if ( !items_ ) {
    items_ = [[NSArray alloc] initWithObjects:
                                @"UIKitPrjLabel",
                                @"UIKitPrjDrawingStrings",
                                @"UIKitPrjDrawingStringsInRect",
                                @"UIKitPrjLineBreak",
                                @"UIKitPrjTextAlignment",
                                @"UIKitPrjBaselineAdjustment",
                                @"UIKitPrjMinFontSize",
                                @"UIKitPrjSizeWithFont",
                                @"UIKitPrjSystemFont",
                                @"UIKitPrjFontWithName",
                                @"UIKitPrjUIImageView",
                                @"UIKitPrjUIImage",
                                @"UIKitPrjBlendMode",
                                @"UIKitPrjImageWithCap",
                                @"UIKitPrjUIImageViewAnimation",
                                @"UIKitPrjAnimationMove",
                                @"UIKitPrjAnimationRepeat",
                                @"UIKitPrjAnimationCurve",
                                @"UIKitPrjAnimationTransform",
                                @"UIKitPrjAnimationObserving",
                                @"UIKitPrjTransition",
                                @"UIKitPrjOpaque",
                                nil ];
  } 
