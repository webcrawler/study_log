...
- (void)viewDidLoad {
  ...
  if ( !items_ ) {
    items_ = [[NSArray alloc] initWithObjects:
                                @"UIKitPrjSegmentedControl",
                                @"UIKitPrjMomentary",
                                @"UIKitPrjSegmentedControlStyle",
                                @"UIKitPrjTintColor",
                                @"UIKitPrjSegmentedControlWithImage",
                                @"UIKitPrjTitleAndImage",
                                @"UIKitPrjContentOffset",
                                @"UIKitPrjEnabled",
                                @"UIKitPrjInsertAndRemove",
                                nil ];
  } 
}
